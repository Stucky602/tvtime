...
export default function App() {
  ...
  if (overlay === 'secret-setup') {
    return (
      <div className="app">
        <SecretSetup
          onDone={() => setOverlay('secret')}
  ...
  return (
    <div className="app">
      ...
      {tab === 'solo' && <SoloTab pulse={pulse} userId={user.id} roomId={room.id} roomPlatforms={room.platforms} />}
      {tab === 'pending' && <PendingTab pulse={pulse} userId={user.id} roomId={room.id} roomPlatforms={room.platforms} />}
      {tab === 'watched' && <WatchedTab pulse={pulse} userId={user.id} roomId={room.id} roomPlatforms={room.platforms} />}
